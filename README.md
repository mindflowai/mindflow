...
The simplest way to use MindFlow is to run `mf ask "What is quantum physics?"` which literally just interfaces directly with chatGPT from the command line. You should get a response like this:
