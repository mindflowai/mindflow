...
from mindflow.db.objects.static_definition.model import MODEL_STATIC, ModelID, ModelName, ModelParameterKey
...
def config():
    ...
    selected_config_index = click.prompt("What do you want to configure? Enter #", type=int)
...
def model_selection():
    model_options = [MODEL_STATIC[ModelID.GPT_3_5_TURBO.value], MODEL_STATIC[ModelID.GPT_4.value]]
    options = [model[ModelParameterKey.NAME.value] for model in model_options]
