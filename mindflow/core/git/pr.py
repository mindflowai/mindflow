...
def create_title_and_body(
    ...
    diff_output = run_diff((base_branch,), summarize=True, note_exclusions=False)
    ...
    # add a newline to the body that says this was generated by mindflow
    body += "\n\nThe above summary was generated by mindflow."  # TODO: a tag instead?
