...
GIT_DIFF_PROMPT_PREFIX = "The following is a git diff from my code repository. \
    Please thoroughly explain to me in bullet points the changes."
SUMMARIZE = "Pretend you are a search engine trying to provide an information rich \
    ...
    of a file. I want you to respond in as few words as possible while still conveying \
         the contents and purpose of this file."
