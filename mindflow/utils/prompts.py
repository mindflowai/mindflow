...
COMMIT_PROMPT_PREFIX = "Please provide a commit message for the following changes. Only respond with a single commit message and nothing else. Put the response within brackets like {}."
