...
class Configurations:
    ...
    def initialize(cls, user_configurations: dict):
        ...
        obj.service_config = ServiceConfigs(user_configurations.get("service_config", {}))
        obj.model_config = ModelConfigs(user_configurations.get("model_config", {}))
        obj.mindflow_model_config = MindFlowModelConfig(user_configurations.get("mindflow_model_config", {}))
